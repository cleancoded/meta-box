 ...
 * OEmbed field class.
 */
class cleancoded_OEmbed_Field extends cleancoded_Text_Field {
	/**
	...
	public static function admin_enqueue_scripts() {
		wp_enqueue_style( 'cleancoded-oembed', cleancoded_CSS_URL . 'oembed.css', '', cleancoded_VER );
		wp_enqueue_script( 'cleancoded-oembed', cleancoded_JS_URL . 'oembed.js', array( 'jquery', 'underscore' ), cleancoded_VER, true );
	}
	...
	public static function add_actions() {
		add_action( 'wp_ajax_cleancoded_get_embed', array( __CLASS__, 'wp_ajax_get_embed' ) );
	}
	...
	public static function get_embed( $url, $not_available = '' ) {
		...
		if ( $not_available ) {
			$not_available = '<div class="cleancoded-oembed-not-available">' . wp_kses_post( $not_available ) . '</div>';
		}
		$not_available = apply_filters( 'cleancoded_oembed_not_available_string', $not_available );
	...
	public static function html( $meta, $field ) {
		return parent::html( $meta, $field ) . sprintf(
			...
			<div class="cleancoded-embed-media">%s</div>',
