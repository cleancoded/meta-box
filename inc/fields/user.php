 ...
 * User field class.
 */
class cleancoded_User_Field extends cleancoded_Object_Choice_Field {
	/**
	 * Add actions.
	 */
	public static function add_actions() {
		add_action( 'wp_ajax_cleancoded_get_users', array( __CLASS__, 'ajax_get_users' ) );
		add_action( 'wp_ajax_nopriv_cleancoded_get_users', array( __CLASS__, 'ajax_get_users' ) );
