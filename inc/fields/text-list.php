 ...
 */
class cleancoded_Text_List_Field extends cleancoded_Multiple_Values_Field {
	/**
	 * Enqueue scripts and styles.
	 */
	public static function admin_enqueue_scripts() {
		wp_enqueue_style( 'cleancoded-text-list', cleancoded_CSS_URL . 'text-list.css', '', cleancoded_VER );
	}
	...
	public static function html( $meta, $field ) {
		...
		$html  = array();
		$input = '<label><span class="cleancoded-text-list-label">%s</span> <input type="text" class="cleancoded-text-list" name="%s" value="%s" placeholder="%s"></label>';
	...
	public static function normalize( $field ) {
		...
		if ( ! $field['clone'] ) {
			$field['class'] .= ' cleancoded-text_list-non-cloneable';
		}
		return $field;
	}
