 ...
 * Fieldset text class.
 */
class cleancoded_Fieldset_Text_Field extends cleancoded_Text_Field {
	/**
	 * Enqueue field scripts and styles.
	 */
	public static function admin_enqueue_scripts() {
		wp_enqueue_style( 'cleancoded-fieldset-text', cleancoded_CSS_URL . 'fieldset-text.css', '', cleancoded_VER );
	}
