 ...
 */
class cleancoded_Image_Field extends cleancoded_File_Field {
	/**
	...
	public static function admin_enqueue_scripts() {
		...
		wp_enqueue_media();
		wp_enqueue_style( 'cleancoded-image', cleancoded_CSS_URL . 'image.css', array(), cleancoded_VER );
	}
	...
	protected static function file_html( $file, $index, $field ) {
		...
		if ( $edit_link ) {
			$edit_link = sprintf( '<a href="%s" class="cleancoded-image-edit" target="_blank"><span class="dashicons dashicons-edit"></span></a>', $edit_link );
		}

		return sprintf(
			'<li class="cleancoded-image-item attachment %s">
				...
				<div class="cleancoded-image-actions">
					%s
					<a href="#" class="cleancoded-image-delete cleancoded-file-delete" data-attachment_id="%s"><span class="dashicons dashicons-no-alt"></span></a>
				</div>
			</li>',
