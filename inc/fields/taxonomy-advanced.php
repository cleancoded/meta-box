 ...
 */
class cleancoded_Taxonomy_Advanced_Field extends cleancoded_Taxonomy_Field {
	/**
	...
	public static function save( $new, $old, $post_id, $field ) {
		...
		cleancoded_Field::save( $new, $old, $post_id, $field );
	}
	...
	public static function raw_meta( $object_id, $field, $args = array() ) {
		$args['single'] = true;
		$meta           = cleancoded_Field::raw_meta( $object_id, $field, $args );
