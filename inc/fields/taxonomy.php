 ...
 */
class cleancoded_Taxonomy_Field extends cleancoded_Object_Choice_Field {
	/**
	 * Add ajax actions callback.
	 */
	public static function add_actions() {
		add_action( 'wp_ajax_cleancoded_get_terms', array( __CLASS__, 'ajax_get_terms' ) );
		add_action( 'wp_ajax_nopriv_cleancoded_get_terms', array( __CLASS__, 'ajax_get_terms' ) );
	}
	...
	protected static function add_term( $field ) {
		$term = cleancoded_request()->post( $field['id'] . '_new' );
	...
	public static function add_new_form( $field ) {
		...
		$html = '
		<div class="cleancoded-taxonomy-add">
			<button class="cleancoded-taxonomy-add-button">%s</button>
			<div class="cleancoded-taxonomy-add-form cleancoded-hidden">
	...
	public static function admin_enqueue_scripts() {
		...
		wp_enqueue_style( 'cleancoded-taxonomy', cleancoded_CSS_URL . 'taxonomy.css', array(), cleancoded_VER );
		wp_enqueue_script( 'cleancoded-taxonomy', cleancoded_JS_URL . 'taxonomy.js', array( 'jquery' ), cleancoded_VER, true );
