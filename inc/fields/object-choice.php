 ...
 */
abstract class cleancoded_Object_Choice_Field extends cleancoded_Choice_Field {
	/**
	 * Show field HTML.
	...
	public static function show( $field, $saved, $post_id = 0 ) {
		...
		$meta = cleancoded_Helpers_Array::flatten( (array) $meta );
	...
	public static function get_attributes( $field, $value = null ) {
		...
		if ( 'select_advanced' === $field['field_type'] ) {
			$attributes['class'] .= ' cleancoded-select_advanced';
		} elseif ( 'select' === $field['field_type'] ) {
			$attributes['class'] .= ' cleancoded-select';
		}
		return $attributes;
	}
	...
	public static function admin_enqueue_scripts() {
		cleancoded_Input_List_Field::admin_enqueue_scripts();
		cleancoded_Select_Field::admin_enqueue_scripts();
		cleancoded_Select_Tree_Field::admin_enqueue_scripts();
		cleancoded_Select_Advanced_Field::admin_enqueue_scripts();
	}
	...
	protected static function get_type_class( $field ) {
		return cleancoded_Helpers_Field::get_class(
			array(
