 ...
 */
class cleancoded_Video_Field extends cleancoded_Media_Field {
	/**
	 * Enqueue scripts and styles.
	 */
	public static function admin_enqueue_scripts() {
		parent::admin_enqueue_scripts();
		wp_enqueue_style( 'cleancoded-video', cleancoded_CSS_URL . 'video.css', array( 'cleancoded-media' ), cleancoded_VER );
		wp_enqueue_script( 'cleancoded-video', cleancoded_JS_URL . 'video.js', array( 'cleancoded-media' ), cleancoded_VER, true );
	...
	public static function print_templates() {
		...
		require_once cleancoded_INC_DIR . 'templates/video.php';
	}
}
