 ...
 * Post field class.
 */
class cleancoded_Post_Field extends cleancoded_Object_Choice_Field {
	/**
	 * Add ajax actions callback.
	 */
	public static function add_actions() {
		add_action( 'wp_ajax_cleancoded_get_posts', array( __CLASS__, 'ajax_get_posts' ) );
		add_action( 'wp_ajax_nopriv_cleancoded_get_posts', array( __CLASS__, 'ajax_get_posts' ) );
	}
