 ...
 * @package Meta Box
 */
class cleancoded_Core {
	/**
	 * Initialization.
	 */
	public function init() {
		load_plugin_textdomain( 'meta-box', false, plugin_basename( cleancoded_DIR ) . '/languages/' );
	...
	public function register_meta_boxes() {
		$configs  = apply_filters( 'cleancoded_meta_boxes', array() );
		$registry = cleancoded_get_registry( 'meta_box' );
