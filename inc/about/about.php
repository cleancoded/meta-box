...
class cleancoded_About {
				...
				<div id="post-body" class="metabox-holder columns-2">
					<div id="post-body-content">
						<div class="about-wrap">
							...
							do_action( 'cleancoded_about_tabs_content' );
							?>
						</div>
					</div>
	...
	public function enqueue() {
		wp_enqueue_style( 'meta-box-about', cleancoded_URL . 'inc/about/css/about.css', array(), cleancoded_VER );
		wp_enqueue_script( 'meta-box-about', cleancoded_URL . 'inc/about/js/about.js', array( 'jquery' ), cleancoded_VER, true );
	}
	...
	public function redirect( $plugin, $network_wide = false ) {
		...
		$is_bulk_activate = 'activate-selected' === cleancoded_request()->post( 'action' ) && count( cleancoded_request()->post( 'checked' ) ) > 1;
	...
	protected function has_menu() {
		return apply_filters( 'cleancoded_admin_menu', false );
	}
